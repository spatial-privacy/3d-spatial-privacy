...
from loading_pointclouds_arcore import *
...
DATABASE_FILE= 'pointnetvlad_arcore_submaps/3d_evaluation_database.pickle' #3d_spaces_evaluation_database
...
BASE_PATH = 'pointnetvlad_arcore_submaps'
all_folders= ['ref_dataset_0','ref_dataset_1']
...
def evaluate(query_sets, query_db_np, output_file):
    ...
    with tf.Graph().as_default():
        ...
        if len(DATABASE_VECTORS) == 0:
            print("Repopulating latent vectors of reference database.")
